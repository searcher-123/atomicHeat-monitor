...
local function button_graphics2(xpos, ypos)
    return {
        filename = "__EvoGUI__/graphics/gui2.png",
        priority = "extra-high-no-scale",
        width = 16,
        height = 16,
        x = xpos,
...
default_gui.EvoGUI_settings2 = {
    type = "button_style",
    parent = "EvoGUI_button_with_icon",

    default_graphical_set = button_graphics2( 0, 48),
    hovered_graphical_set = button_graphics2(16, 48),
    clicked_graphical_set = button_graphics2(32, 48),
}
