...
function FaXiR()
	...
	heat_palette.ranges_numbers={--диапазаны для клеток    
	--здесь от 0 до 500 будет градиент от low "синий" до high "почти серый"
	{range=500,low={r=0,g=0,b=255,a=0.2},high={r=100,g=200,b=200,a=0.1}},
	--здесь от 500 до 950 будет градиент от low "почти белый" до high  "красный"
	{range=950,low={r=250,g=250,b=230,a=0.1},high={r=200,g=160,b=0,a=0.2}},
	--здесь от 500 до 950 будет градиент от low "почти белый" до high  "красный"
	{range=1000,low={r=200,g=0,b=0,a=0.2},high={r=255,g=0,b=0,a=0.3}}
}	
end
